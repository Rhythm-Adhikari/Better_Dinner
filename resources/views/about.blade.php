...
<div class="about">
    ...
    <Section class='head'>
        <h1 class=''>Welcome to Better Dinner!</h1>
    </Section>
        <section class="top">
            <section class="introduction-section">
                <h1>Who Are We</h1>
                <p>We are recent graduates who are desiging a online food ordering/Reservation Website.</p>
                <p>We love programming, networking and a bt of a chill time.</p>
            </section>
            <section class="location-section">
                <h1>Where are we Located</h1>
                <p>We are a small team based on Wollongong and sydeny </p>
            </section>
        </section>
